    ...
    )
{
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface Entry");
    ...
    *ppv = NULL;
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface IMFDeviceTransform or IUnknown");

        *ppv = static_cast< IMFDeviceTransform* >(this);
    }
    else if ( iid == __uuidof( IMFMediaEventGenerator ) )
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface IMFMediaEventGenerator");

        *ppv = static_cast< IMFMediaEventGenerator* >(this);
    }
    else if ( iid == __uuidof( IMFShutdown ) )
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface IMFShutdown");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface IMFTransform");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface IKsControl");

        *ppv = static_cast< IKsControl* >( this );
    }
    else if ( iid == __uuidof( IMFRealTimeClientEx ) )
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface IMFRealTimeClientEx");
    ...
    {
        string strGuid = guidToString(iid);

        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface E_NOINTERFACE %s", strGuid.c_str());
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::QueryInterface Exit");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform pAttributes->GetUnknown");
    ...
    if (SUCCEEDED(pAttributes->GetStringLength(MF_DEVSOURCE_ATTRIBUTE_SOURCE_TYPE_VIDCAP_SYMBOLIC_LINK, &uiSymLinkLen))) // Not available prior to RS5
    {
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform pAttributes->GetString");
    }

    DMFTCHECKHR_GOTO( spFilterUnk.As( &m_spSourceTransform ), done );
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spFilterUnk.As");

    DMFTCHECKHR_GOTO( m_spSourceTransform.As( &m_spIkscontrol ), done );
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform m_spSourceTransform.As");

    DMFTCHECKHR_GOTO( m_spSourceTransform->MFTGetStreamCount( &inputStreams, &outputStreams ), done );
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform m_spSourceTransform->MFTGetStreamCount");
    ...
    if ( inputStreams > 0 || outputStreams > 0 )
    {
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform %d", inputStreams);
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform %d", outputStreams);
        ...
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform pcOutputStreams[%d]: %d", ulIndex, pcOutputStreams[ulIndex]);
            ...
            if (bCustom)
            {
                ...
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform m_CustomPinCount: %d", m_CustomPinCount);
            }
            ...
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spInPin->Init");
            spInPin.Detach();

            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spInPin.Detach()");
        }
        ...
        for (ULONG ulIndex = 0; ulIndex < m_InPins.size(); ulIndex++)
        {
            ...
            if (spiPin.Get())
            {
                ...
                {
                    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform CheckCustomPin");
                ...
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform pPinFactory->CreatePin");

                hr = BridgeInputPinOutputPin(spiPin.Get(), spoPin.Get());
                if (SUCCEEDED(hr))
                {
                    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform BridgeInputPinOutputPin Succeeded");
                    ...
                    ulOutPinIndex++;
                    hr = S_OK;
                    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spoPin.Detach()");
                }
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform m_InputPinCount: %d", m_InputPinCount);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform m_OutputPinCount: %d", m_OutputPinCount);
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform Exit %!HRESULT!", hr);
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetWorkQueueEx Entry");
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::dwWorkQueueId: %d", dwWorkQueueId);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::lWorkItemBasePriority: %d", lWorkItemBasePriority);
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamCount Entry");
    ...
    *pdwOutputStreams    = m_OutputPinCount;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamCount *pdwInputStreams: %d", *pdwInputStreams);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamCount *pdwOutputStreams: %d", *pdwOutputStreams);

done:
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamCount Exit %!HRESULT!", hr);
    return hr;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamIDs Entry");
    ...
    if ( dwInputIDArraySize )
    {
            ...
            dwInputIDArraySize); dwIndex++ )
        {
            ...
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamIDs pdwInputIDs[%d] - %d", dwIndex, pdwInputIDs[dwIndex]);
        }
    }
    ...
    if ( dwOutputIDArraySize )
    {
            ...
            dwOutputIDArraySize); dwIndex++ )
        {
            ...
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamIDs pdwOutputIDs[%d] - %d", dwIndex, pdwOutputIDs[dwIndex]);
        }
    }
done:
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetStreamIDs Exit %!HRESULT!", hr);
    return hr;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputAvailableType Entry");
    ...
    *ppMediaType = nullptr;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputAvailableType Exit %!HRESULT!", hr);
    return hr;
}
...
--*/
{
    ...
    *ppMediaType = nullptr;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputAvailableType Exit %!HRESULT!", hr);
    return hr;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputCurrentType Entry");
    //
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputCurrentType Exit");
    return S_OK;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputCurrentType Entry");
    ...
    *ppMediaType = nullptr;
    ...
    DMFTRACE( DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr );
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputCurrentType Exit %!HRESULT!", hr);
    return hr;
}
...
STDMETHODIMP  CMultipinMft::ProcessEvent(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessEvent Entry");

    UNREFERENCED_PARAMETER(dwInputStreamID);
    UNREFERENCED_PARAMETER(pEvent);

    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessEvent Exit");
    return S_OK;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage Entry");
    ...
    case MFT_MESSAGE_COMMAND_FLUSH:
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_COMMAND_FLUSH");
        //
    ...
    case MFT_MESSAGE_COMMAND_DRAIN:
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_COMMAND_DRAIN");
        //
        // There is no draining for Device MFT. Just kept here for reference
        //
        break;
    case MFT_MESSAGE_NOTIFY_START_OF_STREAM:
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_NOTIFY_START_OF_STREAM");
        //
    ...
    case MFT_MESSAGE_SET_D3D_MANAGER:
        {
           DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_SET_D3D_MANAGER");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_NOTIFY_BEGIN_STREAMING");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_NOTIFY_END_STREAMING");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage MFT_MESSAGE_NOTIFY_END_OF_STREAM");
    ...
    DMFTRACE( DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr );
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessMessage Exit %!HRESULT!", hr);
    return hr;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessInput Entry");
    ...
    DMFTRACE( DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr );
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessInput Exit %!HRESULT!", hr);
    //
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessOutput Entry");
    ...
    *pdwStatus = 0;
    ...
    for ( DWORD i = 0; i < cOutputBufferCount; i++ )
    {
        ...
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessOutput dwStreamID: %d", dwStreamID);
        ...
        if ( SUCCEEDED(spOpin->ProcessOutput( dwFlags, &pOutputSamples[i],
            pdwStatus ) ) )
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessOutput spOpin->ProcessOutput Succeeded");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ProcessOutput Exit %!HRESULT!", hr);
    return hr;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputStreamAttributes Entry");
    ...
    *ppAttributes = nullptr;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputStreamAttributes Exit %!HRESULT!", hr);
    return hr;
}
...
--*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputStreamAttributes Entry");
    ...
    *ppAttributes = nullptr;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputStreamAttributes GetOutPin");

    DMFTCHECKHR_GOTO(spoPin->getPinAttributes(ppAttributes), done );
done:
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputStreamAttributes Exit %!HRESULT!", hr);
    return hr;
}
...
STDMETHODIMP CMultipinMft::SetInputStreamState(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetInputStreamState Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetInputStreamState Exit %!HRESULT!", hr);
    return hr;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputStreamState Entry");
    ...
    *value =  piPin->GetState();
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputStreamState Exit %!HRESULT!", hr);
    return hr;
}
...
STDMETHODIMP CMultipinMft::SetOutputStreamState(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetOutputStreamState Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetOutputStreamState ChangeMediaTypeEx");
done:    
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetOutputStreamState Exit %!HRESULT!", hr);
    return hr;
}
...
STDMETHODIMP CMultipinMft::GetOutputStreamState(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputStreamState Entry");
    ...
    *pState = spoPin->GetState();
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutputStreamState Exit %!HRESULT!", hr);
    return hr;
}
...
STDMETHODIMP CMultipinMft::GetInputStreamPreferredState(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputStreamPreferredState Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInputStreamPreferredState Exit %!HRESULT!", hr);
   return hr;
}
...
STDMETHODIMP CMultipinMft::FlushInputStream(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::FlushInputStream Entry");
    HRESULT hr = S_OK;
    UNREFERENCED_PARAMETER(dwStreamIndex);
    UNREFERENCED_PARAMETER(dwFlags);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::FlushInputStream Exit %!HRESULT!", hr);
    return hr;
}
...
STDMETHODIMP CMultipinMft::FlushOutputStream(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::FlushOutputStream Entry");
    HRESULT hr = S_OK;
    UNREFERENCED_PARAMETER(dwFlags);
    CAutoLock Lock(m_critSec);
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::FlushOutputStream Exit %!HRESULT!", hr);
    return hr;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::FlushAllStreams Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::FlushAllStreams Exit");
}
...
STDMETHODIMP CMultipinMft::KsProperty(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::KsProperty Entry");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! IsEqualCLSID(pProperty->Set, PROPSETID_VIDCAP_VIDEOCONTROL");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! m_spIkscontrol->KsProperty");
done:
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::KsProperty Exit %!HRESULT!", hr);
...
STDMETHODIMP CMultipinMft::KsEvent(
    ...
    --*/
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::KsEvent Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::KsEvent Exit %!HRESULT!", hr);
    return hr;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetAttributes Entry");
    ...
    *ppAttributes = nullptr;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetAttributes Exit %!HRESULT!", hr);
    return hr;
}
#endif
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetDefaultAllocator Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetDefaultAllocator Exit");
    return S_OK;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetAllocatorUsage Entry");
    CAutoLock Lock(m_critSec);
    ...
    *peUsage = outPin->GetSampleAllocatorUsage();
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetAllocatorUsage Exit");
    return S_OK;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInPin Entry");
    CInPin *inPin = NULL;
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetInPin Exit");
    return inPin;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutPin Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetOutPin Exit");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetConnectedInpin Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetConnectedInpin Exit %!HRESULT!", hr);
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx Entry");
    ...
    if (pMediaType)
    {
        ...
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spoPin->IsMediaTypeSupported");
        }
    }
 
    DMFTCHECKHR_GOTO(GetConnectedInpin(pinId, ulInPinId), done);
    spinPin = GetInPin(ulInPinId); // Get the input pin
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx GetInPin");

    (VOID)spinPin->getMediaType(&pInputMediaType);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spinPin->getMediaType");

    oldInputStreamState = spinPin->SetState(DeviceStreamState_Disabled); // Disable input pin
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spinPin->SetState");

    oldOutPinState      = spoPin->SetState(DeviceStreamState_Disabled);  // Disable output pin
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spoPin->SetState");

    (void)spoPin->FlushQueues();  // Flush the output queues
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spoPin->FlushQueues");

    (void)spinPin->FlushQueues(); // Flush the input queues
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spinPin->FlushQueues");

    newOutStreamState = pinStateTransition[oldOutPinState][reqState];  // New state needed  
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx newOutStreamState: %d", newOutStreamState);
        ...
        )
    {
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spinPin->setPreferredMediaType");

        spinPin->setPreferredStreamState(newRequestedInPinState);
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spinPin->setPreferredStreamState");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx SendEventToManager");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spinPin->WaitForSetInputPinMediaChange");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spoPin->ChangeMediaTypeFromInpin");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx spoPin->SetFirstSample");
    }
    else
    {
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::ChangeMediaTypeEx Exit %!HRESULT!", hr);
    return hr;
}
...
HRESULT CMultipinMft::SendEventToManager(
        ...
        --*/
    {
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SendEventToManager Entry");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SendEventToManager Exit %!HRESULT!", hr);
         return hr;
    }
/*++
Description:
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::BridgeInputPinOutputPin Entry");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::BridgeInputPinOutputPin piPin->GetMediaTypeAt");

        GUID subType = GUID_NULL;
        DMFTCHECKHR_GOTO( spMediaType->GetGUID(MF_MT_SUBTYPE,&subType), done );
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::BridgeInputPinOutputPin spMediaType->GetGUID");

            DMFTCHECKHR_GOTO(hr = poPin->AddMediaType(NULL, spMediaType.Get() ), done );
            if (hr == S_OK)
            {
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::BridgeInputPinOutputPin poPin->AddMediaType");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::BridgeInputPinOutputPin Exit %!HRESULT!", hr);
    return hr;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::Shutdown Entry");
...
#endif
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::Shutdown Exit");
    return ShutdownEventGenerator();
}

STDMETHODIMP_(HRESULT __stdcall) CMultipinMft::GetShutdownStatus(MFSHUTDOWN_STATUS* pStatus)
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::GetShutdownStatus");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::CreateInstance Entry");
    ...
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::CreateInstance Exit %!HRESULT!", hr);
    return hr;
}
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins Entry");
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins m_CustomPinCount: %d", m_CustomPinCount);
        ...
        for (ULONG ulIndex = 0; ulIndex < m_InPins.size(); ulIndex++)
        {
                ...
                && ( isCustom ) )
            {
                ...
                if ( State == DeviceStreamState_Run )
                {
                    ...
                    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins pInPin->GetMediaTypeAt");
                }
                pInPin->SetState(DeviceStreamState_Disabled);
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins pInPin->SetState");

                pInPin->setPreferredMediaType(spMediaType.Get());
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins pInPin->setPreferredMediaType");

                pInPin->setPreferredStreamState(State);
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins pInPin->setPreferredStreamState");
                ...
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins SendEventToManager");
                //
                // The media type will be set on the input pin by the time we return from the wait.
                ...
                DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins pInPin->WaitForSetInputPinMediaChange");
              }
        }
    }
done:
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "%!FUNC! exiting %x = %!HRESULT!", hr, hr);
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::SetStreamingStateCustomPins Exit %!HRESULT!", hr);
    return hr;
}
