...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "IsOptimizedPlanarVideoInputImageOutputPair Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CompareMediaTypesForConverter Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CheckCustomPin Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CreateDecoderFromLuid Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "ConfigureAllocator Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CreateAllocator Entry");
