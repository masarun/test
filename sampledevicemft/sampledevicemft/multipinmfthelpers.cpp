...
STDMETHODIMP CDecoderTee::Configure(_In_opt_ IMFMediaType *inType,
    ...
    _Outptr_ IMFTransform** ppTransform)
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CDecoderTee::Configure Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CDecoderTee::ProcessFormatChange Entry");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CDecoderTee::ConfigDecoder Entry");
...
HRESULT CPinCreationFactory::CreatePin(_In_ ULONG ulInputStreamId, /* The Input stream Id*/
    ...
    _In_ BOOL& isCustom)
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CPinCreationFactory::CreatePin Entry");
    ...
    *ppPin = nullptr;
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform type == DMFT_PIN_INPUT");
        ...
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform new CCustomPin");
        ...
        else
        {
            ...
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform new CAsyncInPin");
...
#else
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform new CInPin");
    ...
    {
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform type == DMFT_PIN_OUTPUT");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spInPin.Get()");

        DMFTCHECKHR_GOTO(spInPin.As(&spKscontrol), done);   // Grab the IKSControl off the input pin
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spInPin.As");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spInPin->GetGUID");

#if defined MF_DEVICEMFT_DECODING_MEDIATYPE_NEEDED
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform new CTranslateOutPin");
        spOutPin = new (std::nothrow) CTranslateOutPin(ulOutStreamId, m_spDeviceTransform.Get(), spKscontrol.Get());         // Create the output pin
#else
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform new COutPin");
        ...
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spOutPin->SetGUID");

        DMFTCHECKHR_GOTO(spOutPin->SetUINT32(MF_DEVICESTREAM_STREAM_ID, ulOutStreamId), done);       // Advertise the stream Id to the Pipeline
        DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spOutPin->SetUINT32");
        ...
        {
            DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CMultipinMft::InitializeTransform spInPin->GetUINT32");
...
{
    DMFTRACE(DMFT_GENERAL, TRACE_LEVEL_INFORMATION, "CheckPinType Entry");
